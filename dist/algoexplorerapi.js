...
const { addBlockProviders } = require("./src/providers");
...
const AlgoexplorerApi = function(networkName) {
	...
	addBlockProviders(this);
};

module.exports = AlgoexplorerApi;

},{"./src/http/networks":11,"./src/providers":13}],2:[function(require,module,exports){
...
async function queryBlock(config, round) {
	...
	if (typeof (round) === "number") {
		result = await fetchGet(config.url + "/block/" + round.toString());
	}
	else if (typeof (round) === "string") {
		result = await fetchGet(config.url + "/block/" + round);
	}
	else {
...
},{"../http/request":12}],11:[function(require,module,exports){
const testnet = {
	url: "https://api.testnet.algoexplorer.io/v1",
	genesis: "SGO1GKSzyE7IEPItTxCByw9x8FmnrCDexi9/cOUJOiI=",
	id: "testnet-v1.0"
};

const mainnet = {
	url: "https://api.algoexplorer.io/v1",
	genesis: "wGHE2Pwdvd7S12BL5FaOP20EGYesN73ktiC1qzkkit8=",
	id: "mainnet-v1.0"
};

const betanet = {
	url: "https://api.betanet.algoexplorer.io/v1",
	genesis: "mFgazF+2uRS1tMiL9dsj01hJGySEmPN28B/TjjvpVW0=",
	id: "betanet-v1.0"
};
...
},{"superagent":5}],13:[function(require,module,exports){
const { queryBlock } = require("./block/block");

function addBlockProviders(instance) {

	/**
	* @param {(number|string)} round A block number or block hash
	* @return {object} Block information
	*/
	instance.queryBlock = function (round) {
		return queryBlock(this.config, round);
	};
}
